...
function About() {
  ...
  return (
    <div className='container mx-auto my-12 p-4 space-y-9'>
      ...
      <p>
        this is {""}
        <strong className='text-blue-800 font-semibold hover:scale-105 duration-500'>{profile?.user?.name}</strong>{''}
      ...
      <p>
        Beyond his professional achievements, Abhishek is a big fan of cricket and
